...
- Optional [environment variables](#adding-environment-variables):
    ...
    | `CLUSTER_NODES_IP` | Space-separated list of IPv4 addresses for all nodes in the cluster besides the Login node. This overrides the other `*_NODES_IP` environment variables. | `"192.168.1.16 192.168.1.17"` | `("${MASTER_NODES_IP[@]}" "${WORKER_NODES_IP[@]}")` |
